            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex space-x-6">
                        <a href="#"
                            class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Courses</a>
                ...
                <div class="flex items-center space-x-4">
                    <button class="p-2 rounded-full hover:bg-gray-700 transition relative has-tooltip">
                        ...
                        <span
                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                            Search courses
                        </span>
                    </button>
                    <button class="p-2 rounded-full hover:bg-gray-700 transition relative has-tooltip">
                    ...
                    <div class="relative">
                        <button class="flex items-center space-x-2 hover:bg-gray-700 px-3 py-2 rounded-full transition">
                            ...
                            <span id="completion-badge"
                                class="hidden absolute -top-1 -right-1 bg-primary-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">0</span>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gray-800 rounded-xl p-8 mb-8 border border-gray-700">
            <div class="flex flex-col md:flex-row justify-between">
                <div class="md:w-2/3">
                    <span
                        class="inline-block bg-primary-600 text-white px-3 py-1 rounded-full text-xs font-semibold mb-4">
                        PROFESSIONAL CERTIFICATE
                    </span>
                    <h1 class="text-3xl md:text-4xl font-bold mb-4">The Complete Business Management Course</h1>
                    <p class="text-lg text-gray-300 mb-6">Master essential business management skills including
                        leadership, strategy, finance, marketing, and operations to advance your career or launch your
                        own business.</p>
                ...
                <div class="hidden md:block md:w-1/3">
                    <div class="relative overflow-hidden rounded-lg">
                        <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                            alt="Business Management Course" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
                            <button
                                class="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full hover:bg-white/30 transition">
                                <a href="https://www.youtube.com/watch?v=a-uPznyA7Hw"><i
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-3">
                            <div
                                class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                <div class="flex items-center">
                                    <input type="checkbox" id="lesson-1" class="lesson-checkbox hidden">
                                    <label for="lesson-1" class="flex items-center cursor-pointer">
                                        <span
                                            class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=UnQTs_q7Juo"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=xuGh-jzupzc"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=PjTdVWCHhH8"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                        ...
                        <div class="space-y-3">
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=NY82yptNp5E"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=OALB9RztQKg"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=t1JiPdor_rU"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                        ...
                        <div class="space-y-3">
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=csF5f2bL6Bg"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">45 min</span>
                                    <a href="https://www.youtube.com/watch?v=IIKr2915l2g"
                                        class="text-primary-600 hover:text-primary-500 text-sm has-tooltip">
                                        <i class="fas fa-play"></i>
                                        <span
                                            class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                ...
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                    ...
                    <div class="flex flex-col md:flex-row items-start">
                        <img src="https://randomuser.me/api/portraits/women/65.jpg"
                            class="w-24 h-24 rounded-full object-cover mb-4 md:mb-0 md:mr-6 border-4 border-primary-600/30">
                        <div>
                            ...
                            <p class="text-gray-300 mb-4">
                                With 20+ years of experience in executive leadership and business consulting, Dr.
                                Rodriguez has helped transform dozens of organizations.
                                She holds an MBA from Harvard and a PhD in Organizational Behavior from Stanford. Her
                                practical approach combines academic theory with
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-6">
                    ...
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-6">
                        ...
                        <div class="space-y-4">
                            <a href="https://www.canva.com/documents/templates/business-plan/"
                                class="flex items-center p-3 hover:bg-gray-700 rounded-lg transition">
                            ...
                            <a href="https://chat.whatsapp.com/CqW46y9Fkgh6RT09xO8ylV"
                                class="flex items-center p-3 hover:bg-gray-700 rounded-lg transition">
                    ...
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                        ...
                        <div class="space-y-4">
                            <a href="AI&Machine Learning.php"
                                class="flex items-center hover:bg-gray-700 p-3 -m-3 rounded-lg transition">
