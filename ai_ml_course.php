...
// *** IMPORTANT: USE A UNIQUE SLUG FOR THIS COURSE ***
$course_slug = 'ml-bootcamp'; // Example slug for this course
$course_title_display = 'AI & Machine Learning Bootcamp'; // Title shown on the page
$is_paid_course = true; // Example: Let's assume this one is paid
...
if ($user_logged_in) {
    ...
    if (isset($mysqli) && $mysqli instanceof mysqli && !$mysqli->connect_error) {
        ...
        error_log("Database connection error in $course_slug page for enrollment check: " . $db_error);
    }
}
...
<head>
    ...
    <style>
        ...
        .lesson-checkbox:checked + label .fa-check { /* Added for dynamic checkmark */
        ...
        .tooltip {
            ...
            z-index: 10; /* Added for visibility */
        }
        ...
        @keyframes spin { to { transform: rotate(360deg); } }
         ...
         #course-content-section { scroll-margin-top: 90px; } /* Added ID and scroll margin */
    </style>
</head>
<body class="bg-gray-900 text-gray-100 min-h-screen">
                    ...
                    <div class="relative">
                        <?php if ($user_logged_in): ?>
                            <a href="Dashboard.php" class="flex items-center space-x-2 hover:bg-gray-700 px-3 py-2 rounded-full transition" title="Go to Dashboard">
                                <!-- You might want to fetch the actual user's picture later -->
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gray-800 rounded-xl p-8 mb-8 border border-gray-700">
            <div class="flex flex-col md:flex-row justify-between">
                <div class="md:w-2/3">
                    ...
                    <!-- Using PHP variable for Title -->
                    <h1 class="text-3xl md:text-4xl font-bold mb-4"><?php safe_echo($course_title_display); ?></h1>
                    <p class="text-lg text-gray-300 mb-6">Master artificial intelligence and machine learning from the ground up with Python, TensorFlow, and real-world projects. Build models that solve complex problems.</p>
                    ...
                    <div class="flex items-center space-x-4" id="enrollment-action-area">
                       ...
                       <?php else: ?>
                            <!-- Using PHP vars for dynamic button -->
                            <button id="enroll-btn" data-course-slug="<?php safe_echo($course_slug); ?>" class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-medium transition duration-200 flex items-center justify-center text-base shadow-md">
                                <span class="btn-text">Enroll Now<?php echo $is_paid_course ? '' : ' - Free'; ?></span> <!-- Add Price/Free Text if needed -->
                    ...
                    <div class="relative overflow-hidden rounded-lg">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
                            <button class="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full hover:bg-white/30 transition">
                                <a href="https://www.youtube.com/watch?v=AMxtGWcMYd4&t=296s"><i class="fas fa-play text-white"></i></a>
                            </button>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <!-- Main Content (Original Curriculum) -->
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8" id="course-content-section"> <!-- Added ID -->
                    <h2 class="text-2xl font-bold mb-6">Course Curriculum</h2>

                    <!-- Module 1 -->
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-xl font-semibold text-primary-500">Module 1: Python for AI</h3>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                <div class="flex items-center">
                                    ...
                                    <label for="lesson-1" class="flex items-center cursor-pointer">
                                        ...
                                        <span>Python Fundamentals for Data Science</span>
                                    </label>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">30 min</span>
                                    <a href="https://www.youtube.com/watch?v=7eh4d6sabA0" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                            ...
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                <div class="flex items-center">
                                    ...
                                    <label for="lesson-2" class="flex items-center cursor-pointer">
                                        ...
                                        <span>NumPy and Pandas Mastery</span>
                                    </label>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">45 min</span>
                                    <a href="https://www.youtube.com/watch?v=KHoEbRH46Zk" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                            ...
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=FN78JowwpSY" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                             ...
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center"><input type="checkbox" id="lesson-3b" class="lesson-checkbox hidden"><label for="lesson-3b" class="flex items-center cursor-pointer"><span class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600 hidden"></i></span><span>Working with APIs and Web Scraping</span></label></div><div class="flex items-center space-x-3"><span class="text-sm text-gray-400">50 min</span><a href="#" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"><i class="fas fa-play"></i><span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">Start</span></a></div></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-xl font-semibold text-purple-500">Module 2: Machine Learning Fundamentals</h3>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=fM8XdC1EweU" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                            ...
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=WWqE7YHR4Jc" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                            ...
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=E0Hmnixke2g" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                             ...
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center"><input type="checkbox" id="lesson-6b" class="lesson-checkbox hidden"><label for="lesson-6b" class="flex items-center cursor-pointer"><span class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600 hidden"></i></span><span>Clustering Techniques (K-Means)</span></label></div><div class="flex items-center space-x-3"><span class="text-sm text-gray-400">45 min</span><a href="https://www.youtube.com/watch?v=4b5d3muPQmA" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"><i class="fas fa-play"></i><span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">Start</span></a></div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center"><input type="checkbox" id="lesson-6c" class="lesson-checkbox hidden"><label for="lesson-6c" class="flex items-center cursor-pointer"><span class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600 hidden"></i></span><span>Model Evaluation & Selection</span></label></div><div class="flex items-center space-x-3"><span class="text-sm text-gray-400">40 min</span><a href="https://www.youtube.com/watch?v=v6DtYYafrWQ" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"><i class="fas fa-play"></i><span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">Start</span></a></div></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-xl font-semibold text-green-500">Module 3: Deep Learning with TensorFlow</h3>
                            <span class="text-sm text-gray-400">4 lessons</span>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                ...
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">45 min</span>
                                    <a href="https://www.youtube.com/watch?v=jmmW0F0biz0" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                            ...
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                                <div class="flex items-center">
                                    ...
                                    <label for="lesson-8" class="flex items-center cursor-pointer">
                                        ...
                                        <span>Building Models with TensorFlow/Keras</span>
                                    </label>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">60 min</span>
                                    <a href="https://www.youtube.com/watch?v=7kLi8u2dJz0" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"> <!-- Added relative -->
                                        <i class="fas fa-play"></i>
                                        <span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">
                                            Start Lesson
                                        </span>
                             ...
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center"><input type="checkbox" id="lesson-9" class="lesson-checkbox hidden"><label for="lesson-9" class="flex items-center cursor-pointer"><span class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600 hidden"></i></span><span>Convolutional Neural Networks (CNNs)</span></label></div><div class="flex items-center space-x-3"><span class="text-sm text-gray-400">75 min</span><a href="https://www.youtube.com/watch?v=QzY57FaENXg" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"><i class="fas fa-play"></i><span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">Start</span></a></div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center"><input type="checkbox" id="lesson-10" class="lesson-checkbox hidden"><label for="lesson-10" class="flex items-center cursor-pointer"><span class="w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600 hidden"></i></span><span>Recurrent Neural Networks (RNNs)</span></label></div><div class="flex items-center space-x-3"><span class="text-sm text-gray-400">70 min</span><a href="https://www.youtube.com/watch?v=AsNTP8Kwu80" class="text-primary-600 hover:text-primary-500 text-sm has-tooltip relative"><i class="fas fa-play"></i><span class="tooltip absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded whitespace-nowrap">Start</span></a></div></div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                    ...
                    <div class="flex flex-col md:flex-row items-start">
                        <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-24 h-24 rounded-full object-cover mb-4 md:mb-0 md:mr-6 border-4 border-primary-600/30 flex-shrink-0">
                        <div>
                            <h3 class="text-xl font-bold mb-1">Dr. Sarah Johnson</h3>
                            <p class="text-primary-500 mb-3">AI Research Scientist | EduPro Lead Instructor</p>
                            <p class="text-gray-300 mb-4">
                                Former AI researcher at Google Brain with a PhD in Machine Learning from Stanford.
                                Dr. Johnson has published over 50 papers in top-tier conferences and brings both cutting-edge research
                                and practical industry experience to this course.
                            </p>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 space-y-6"> <!-- Adjusted top value -->
                    <!-- Course Features -->
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
    ...
    <script>
        // --- JAVASCRIPT (Copied from ai_course.php, adapted for this course) ---
        document.addEventListener('DOMContentLoaded', function() {

            const checkboxes = document.querySelectorAll('.lesson-checkbox');
            // Calculate total lessons based on checkboxes present, fallback if none
            const totalLessonsForProgress = checkboxes.length > 0 ? checkboxes.length : 18; // Adjust fallback number if needed
            ...
            function updateProgress() {
                ...
                if (progressText) progressText.textContent = `${completed}/${totalLessonsForProgress} lessons completed`; // Use dynamic total
            ...
            function updateCompletionBadge() {
                ...
                if (completionBadge) { // Only if badge exists (user logged in)
                    if (completed > 0) {
            ...
            checkboxes.forEach(checkbox => {
                const lessonId = checkbox.id;
                 // Use course-specific key for local storage
                ...
                checkbox.addEventListener('change', function() {
                    localStorage.setItem(storageKey, this.checked); // Use course-specific key
            ...
            updateProgress();
            updateCompletionBadge(); // Initial updates
            ...
            const isPaidCourse = <?php echo json_encode($is_paid_course); ?>; // Get paid status
            ...
            if (enrollButton && enrollmentActionArea) {
                ...
                enrollButton.addEventListener('click', function() {
                    ...
                    // Add payment check/redirect here if it's a paid course
                    if (isPaidCourse) {
                        // Example: Redirect to a payment page or show a payment modal
                        // alert('Redirecting to payment...');
                        // window.location.href = 'payment.php?course=<?php safe_echo($course_slug); ?>';
                        // For now, we'll just proceed with enrollment via fetch for testing
                        console.log("Paid course - skipping actual payment for now, proceeding with enroll fetch.");
                    }
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            if (data.action === 'redirect_login') {
                                ...
                                enrollButtonText.textContent = 'Enroll Now' + (isPaidCourse ? '' : ' - Free'); // Reset button text
